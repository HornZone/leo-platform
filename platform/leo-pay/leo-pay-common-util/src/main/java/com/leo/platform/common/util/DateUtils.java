...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
     ...
     * 
     * @param dt java.sql.Timestamp instance
     * @param sFmt Date 格式，DATE_FORMAT_DATEONLY/DATE_FORMAT_DATETIME/ DATE_FORMAT_SESSION
     * @return
     * @since 1.0
     * @history
     */
    ...
    public static long getDateDiff(String startDate, String endDate) {
        ...
        try {
            ...
            diff =
                (date1.getTime() - date2.getTime()) / (24 * 60 * 60 * 1000) > 0 ? (date1.getTime() - date2.getTime())
    ...
    public static long getTimeDiff(Date date1, Date date2) {
        ...
        long diff =
            (date1.getTime() - date2.getTime()) > 0 ? (date1.getTime() - date2.getTime()) : (date2.getTime() - date1
                .getTime());
        return diff;
    }
