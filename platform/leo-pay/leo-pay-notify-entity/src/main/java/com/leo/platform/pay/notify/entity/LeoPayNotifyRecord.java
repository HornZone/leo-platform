package com.leo.platform.pay.notify.entity;
...
/** 
 */
public class LeoPayNotifyRecord extends BaseEntity {
    ...
    public LeoPayNotifyRecord() {
        super();
    }

    public LeoPayNotifyRecord(Date createTime, Date lastNotifyTime, Integer notifyTimes, Integer limitNotifyTimes,
        String url, String merchantNo, String merchantOrderNo, NotifyStatusEnum status, NotifyTypeEnum type) {
        super();
