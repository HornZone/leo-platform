 ...
 */
public class LpOrderResultQueryVo extends BaseEntity {
    ...
    public LpOrderResultQueryVo() {
        super();
    }

    public LpOrderResultQueryVo(Date createTime, String notifyRule, Date lastNotifyTime, Integer notifyTimes,
        Integer limitNotifyTimes, String bankOrderNo, NotifyStatusEnum status) {
        super();
