package com.leo.platform.pay.trade.utils.alipay.util;
...
/* *
 * 类名：AlipaySubmit功能：支付宝各接口请求提交类详细：构造支付宝各接口表单HTML文本，获取远程HTTP数据<p>说明：
...
public class AlipaySubmit {
    ...
    public static String query_timestamp() throws MalformedURLException, DocumentException, IOException {
        ...
        String strUrl =
            ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfigUtil.partner + "&_input_charset"
