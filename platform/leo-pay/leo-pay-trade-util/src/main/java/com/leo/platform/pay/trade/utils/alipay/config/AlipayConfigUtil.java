package com.leo.platform.pay.trade.utils.alipay.config;
...
/**
 * 类名：AlipayConfigUtil 功能：基础配置类 详细：设置帐户有关信息及返回路径 说明： 以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己网站的需要，按照技术文档编写,并非一定要使用该代码。
