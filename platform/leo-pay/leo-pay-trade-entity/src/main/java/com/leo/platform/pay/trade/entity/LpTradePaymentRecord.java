package com.leo.platform.pay.trade.entity;
 ...
 * <b>功能说明:商户支付记录实体类</b>
 */
public class LpTradePaymentRecord extends BaseEntity implements Serializable {
    ...
    public String getPayWayNameDesc() {
        return PayWayEnum.getEnum(this.getPayWayCode()).getDesc() + "-"
            + PayTypeEnum.getEnum(this.getPayTypeCode()).getDesc();
    }
