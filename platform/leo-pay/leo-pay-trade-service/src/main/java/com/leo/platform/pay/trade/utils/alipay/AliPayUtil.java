package com.leo.platform.pay.trade.utils.alipay;
...
import com.leo.platform.pay.trade.utils.alipay.sign.MD5;
import com.leo.platform.pay.trade.utils.alipay.util.httpclient.HttpProtocolHandler;
import com.leo.platform.pay.trade.utils.alipay.util.httpclient.HttpRequest;
import com.leo.platform.pay.trade.utils.alipay.util.httpclient.HttpResponse;
import com.leo.platform.pay.trade.utils.alipay.util.httpclient.HttpResultType;
...
public class AliPayUtil {
     ...
     * @return
     */
    public static Map<String, Object> tradePay(String outTradeNo, String authCode, String subject, BigDecimal amount,
        String body, List<LeoPayGoodsDetails> roncooPayGoodsDetailses) {
        logger.info("======>支付宝被扫");
        ...
        AlipayClient alipayClient =
            new DefaultAlipayClient(AlipayConfigUtil.trade_pay_url, AlipayConfigUtil.app_id,
                AlipayConfigUtil.mch_private_key, format, charset, AlipayConfigUtil.ali_public_key, signType);
        ...
        if (roncooPayGoodsDetailses != null && roncooPayGoodsDetailses.size() > 0) {
            ...
            for (LeoPayGoodsDetails roncooPayGoodsDetails : roncooPayGoodsDetailses) {
    ...
    public static Map<String, Object> tradeQuery(String outTradeNo) {
        ...
        String signType = "RSA2";
        AlipayClient alipayClient =
            new DefaultAlipayClient(AlipayConfigUtil.trade_query_url, AlipayConfigUtil.app_id,
                AlipayConfigUtil.mch_private_key, format, charset, AlipayConfigUtil.ali_public_key, signType);
