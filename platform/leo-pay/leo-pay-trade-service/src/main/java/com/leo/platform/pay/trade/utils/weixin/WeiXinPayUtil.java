package com.leo.platform.pay.trade.utils.weixin;
...
import com.leo.platform.pay.trade.utils.MD5Util;
...
public class WeiXinPayUtil {
     ...
     * @return
     */
    public static Map<String, Object> micropay(String outTradeNo, String body, BigDecimal totalAmount,
        ...
        Map<String, Object> resultMap =
            WeiXinPayUtils.httpXmlRequest("https://api.mch.weixin.qq.com/pay/micropay", "POST", data);
     ...
     * @return
     */
    public static Map<String, Object> appletPay(String outTradeNo, String body, BigDecimal totalAmount,
        String spbillCreateIp, String notifyUrl, String openid, List<LeoPayGoodsDetails> goodsDetails) {
        String nonce_str = getnonceStr();
        ...
        if (goodsDetails != null && !goodsDetails.isEmpty()) {
            ...
            for (LeoPayGoodsDetails goodsDetail : goodsDetails) {
        ...
        Map<String, Object> resultMap =
            WeiXinPayUtils.httpXmlRequest("https://api.mch.weixin.qq.com/pay/unifiedorder", "POST", data);
    ...
    private static String mapToXml(SortedMap<String, Object> paramMap) {
        ...
        for (Map.Entry<String, Object> entry : paramMap.entrySet()) {
            if (!StringUtil.isEmpty(entry.getValue())) {
                dataBuilder.append("<").append(entry.getKey()).append(">").append(entry.getValue()).append("</")
