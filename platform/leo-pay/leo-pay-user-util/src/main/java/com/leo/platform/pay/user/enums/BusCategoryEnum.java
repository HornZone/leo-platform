package com.leo.platform.pay.user.enums;
...
public enum BusCategoryEnum {
    ...
    DSTG("1017", "电商团购", "0", "5000", "0", "24"), QT("1018", "其他", "0", "5000", "0", "24");
    ...
    private BusCategoryEnum(String code, String desc, String minAmount, String maxAmount, String beginTime,
        String endTime) {
        this.code = code;
        this.desc = desc;
        this.minAmount = minAmount;
