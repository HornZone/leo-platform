package com.leo.platform.common.security;
 ...
 * 
 * From http://www.gnu.org/licenses/license-list.html: Being in the public domain is not a license--rather, it means the
 * material is not copyrighted and no license is needed. Practically speaking, though, if a work is in the public
 * domain, it might as well have an all-permissive non-copyleft free software license. Public domain status is
 * compatible with the GNU GPL.
 * 
 * As this class has been released under the public domain, it has been corporated into the sugar package which is
