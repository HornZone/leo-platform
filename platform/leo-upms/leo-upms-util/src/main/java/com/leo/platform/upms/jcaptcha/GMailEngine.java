...
/**
 * from
 * https://code.google.com/p/musicvalley/source/browse/trunk/musicvalley/doc/springSecurity/springSecurityIII/src/main
 * /java/com/spring/security/jcaptcha/GMailEngine.java?spec=svn447&r=447 JCaptcha验证码图片生成引擎,
...
public class GMailEngine extends ListImageCaptchaEngine {
    ...
    protected void buildInitialFactories() {
        ...
        TextPaster randomPaster =
            new DecoratedRandomTextPaster(minWordLength, maxWordLength, new RandomListColorGenerator(new Color[] {
        ...
        FontGenerator font =
            new RandomFontGenerator(fontSize, fontSize, new Font[] {new Font("nyala", Font.BOLD, fontSize),
