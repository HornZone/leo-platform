...
public class PermissionDaoImpl extends BaseDaoImpl<Permission, Long> implements PermissionDao {
    ...
    public int insert(Permission entity) {
        ...
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
     ...
     * @return
     */
    public int insertSelective(Permission entity) {
        // 父类为BaseBizEntity的entity保存时需要自动记录username、createTime和lastUpdateTime属性
        if (entity instanceof BaseBizEntity) {
            BaseBizEntity baseInfo = (BaseBizEntity)entity;
            String username = (String)SecurityUtils.getSubject().getPrincipal();
     ...
     * @return
     */
    public int insertBatch(List<Permission> entityList) {
        try {
            String username = (String)SecurityUtils.getSubject().getPrincipal();
            Date now = new Date();
            ...
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.insertList(entityList);
        } catch (Exception e) {
    ...
    public int delete(Permission record) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.delete(record);
        } catch (Exception e) {
     ...
     * @return
     */
    public int updateByPrimaryKey(Permission object) {
        if (object == null) {
        ...
        PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
        int records = permissionDao.updateByPrimaryKey(object);
     ...
     * @return
     */
    public int updateByPrimaryKeySelective(Permission object) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Permission oldObject = null;
        ...
        PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
        int records = permissionDao.updateByPrimaryKeySelective(object);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public int updateByExample(Permission object, Object example) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Permission oldObject = null;
        ...
        PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
        int records = permissionDao.updateByExample(object, example);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public int updateByExampleSelective(Permission object, Object example) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Permission oldObject = null;
        ...
        PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
        int records = permissionDao.updateByExampleSelective(object, example);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public List<Permission> select(Permission record) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.select(record);
        } catch (Exception e) {
     ...
     * @return
     */
    public List<Permission> selectAll(Long id) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
     ...
     * @return
     */
    public Permission selectOne(Permission record) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectOne(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public int selectCount(Permission record) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectCount(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Permission> selectByExample(Object example) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
    ...
    public int selectCountByExample(Object example) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectCountByExample(example);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Permission> selectByRowBounds(Permission record, RowBounds rowBounds) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectByRowBounds(record, rowBounds);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Permission> selectByExampleAndRowBounds(Object example, RowBounds rowBounds) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectByExampleAndRowBounds(example, rowBounds);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Permission> selectByIds(String ids) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectByIds(ids);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    /** 其他的tk.mapper通用方法实现 **/
    @Override
    public Permission selectByPrimaryKey(Object key) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.selectByPrimaryKey(key);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    @Override
    public int insertList(List<Permission> recordList) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.insertList(recordList);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    @Override
    public int insertUseGeneratedKeys(Permission record) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.insertUseGeneratedKeys(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    public int deleteByPrimaryKey(Object key) {
        try {
            PermissionDao permissionDao = getSqlSession().getMapper(PermissionDao.class);
            return permissionDao.deleteByPrimaryKey(key);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
