...
public class OrganizationDaoImpl extends BaseDaoImpl<Organization, Long> implements OrganizationDao {
    ...
    public int insert(Organization entity) {
        ...
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
     ...
     * @return
     */
    public int insertSelective(Organization entity) {
        // 父类为BaseBizEntity的entity保存时需要自动记录username、createTime和lastUpdateTime属性
        if (entity instanceof BaseBizEntity) {
            BaseBizEntity baseInfo = (BaseBizEntity)entity;
        ...
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.insertSelective(entity);
            // T result = get((PK) entity.getId());
        } catch (Exception e) {
            throw new DAOException("数据创建失败，可能存在数据唯一性冲突", e);
        }
     ...
     * @return
     */
    public int insertBatch(List<Organization> entityList) {
        try {
            String username = (String)SecurityUtils.getSubject().getPrincipal();
            Date now = new Date();
            ...
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.insertList(entityList);
        } catch (Exception e) {
     ...
     * @param record
     */
    public int delete(Organization record) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.delete(record);
        } catch (Exception e) {
    ...
    public int deleteByExample(Object example) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.deleteByExample(example);
        } catch (Exception e) {
            throw new DAOException("当前数据可能被其他记录引用，无法删除！", e);
        }
    }
     ...
     * @return
     */
    public int updateByPrimaryKey(Organization object) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Organization oldObject = null;
        // 父类为BaseBizEntity的entity保存时需要自动记录username、createTime和lastUpdateTime属性
        ...
        OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
        int records = organizationDao.updateByPrimaryKey(object);
     ...
     * @return
     */
    public int updateByPrimaryKeySelective(Organization object) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Organization oldObject = null;
        ...
        OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
        int records = organizationDao.updateByPrimaryKeySelective(object);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public int updateByExample(Organization object, Object example) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Organization oldObject = null;
        ...
        OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
        int records = organizationDao.updateByExample(object, example);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public int updateByExampleSelective(Organization object, Object example) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Organization oldObject = null;
        ...
        OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
        int records = organizationDao.updateByExampleSelective(object, example);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public List<Organization> select(Organization record) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
     ...
     * @return
     */
    public List<Organization> selectAll(Long id) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
     ...
     * @return
     */
    public Organization selectOne(Organization record) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectOne(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    public int selectCount(Organization record) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectCount(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Organization> selectByExample(Object example) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
    ...
    public int selectCountByExample(Object example) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectCountByExample(example);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Organization> selectByRowBounds(Organization record, RowBounds rowBounds) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectByRowBounds(record, rowBounds);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Organization> selectByExampleAndRowBounds(Object example, RowBounds rowBounds) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectByExampleAndRowBounds(example, rowBounds);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    public List<Organization> selectByIds(String ids) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectByIds(ids);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    /** 其他的tk.mapper通用方法实现 **/
    @Override
    public Organization selectByPrimaryKey(Object key) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.selectByPrimaryKey(key);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    @Override
    public int insertList(List<Organization> recordList) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.insertList(recordList);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    @Override
    public int insertUseGeneratedKeys(Organization record) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.insertUseGeneratedKeys(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    public int deleteByPrimaryKey(Object key) {
        try {
            OrganizationDao organizationDao = getSqlSession().getMapper(OrganizationDao.class);
            return organizationDao.deleteByPrimaryKey(key);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
