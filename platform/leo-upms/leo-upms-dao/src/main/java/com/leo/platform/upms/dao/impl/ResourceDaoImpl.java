...
public class ResourceDaoImpl extends BaseDaoImpl<Resource, Long> implements ResourceDao {
     ...
     */
    private final static Logger logger = LoggerFactory.getLogger(ResourceDaoImpl.class);
    ...
    public int insert(Resource entity) {
        ...
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
     ...
     * @return
     */
    public int insertSelective(Resource entity) {
        // 父类为BaseBizEntity的entity保存时需要自动记录username、createTime和lastUpdateTime属性
        if (entity instanceof BaseBizEntity) {
            BaseBizEntity baseInfo = (BaseBizEntity)entity;
        ...
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.insertSelective(entity);
            // T result = get((PK) entity.getId());
        } catch (Exception e) {
            throw new DAOException("数据创建失败，可能存在数据唯一性冲突", e);
        }
     ...
     * @return
     */
    public int insertBatch(List<Resource> entityList) {
        try {
            String username = (String)SecurityUtils.getSubject().getPrincipal();
            Date now = new Date();
            ...
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.insertList(entityList);
        } catch (Exception e) {
     ...
     * @param record
     */
    public int delete(Resource record) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.delete(record);
        } catch (Exception e) {
     ...
     * @return
     */
    public int updateByPrimaryKey(Resource object) {
        if (object == null) {
        ...
        ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
        int records = resourceDao.updateByPrimaryKey(object);
     ...
     * @return
     */
    public int updateByPrimaryKeySelective(Resource object) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Resource oldObject = null;
        ...
        ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
        int records = resourceDao.updateByPrimaryKeySelective(object);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public int updateByExample(Resource object, Object example) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Resource oldObject = null;
        ...
        ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
        int records = resourceDao.updateByExample(object, example);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public int updateByExampleSelective(Resource object, Object example) {
        if (object == null) {
            throw new NullPointerException("需要更新的对象不能为空");
        }
        Resource oldObject = null;
        ...
        ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
        int records = resourceDao.updateByExampleSelective(object, example);
        if (records == 0 || records == -1) {
            throw new OptLockException("数据已被修改或删除！请刷新后重试！");
        }
        return records;
     ...
     * @return
     */
    public List<Resource> select(Resource record) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.select(record);
        } catch (Exception e) {
     ...
     * @return
     */
    public Resource selectOne(Resource record) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.selectOne(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public int selectCount(Resource record) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.selectCount(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    public int selectCountByExample(Object example) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.selectCountByExample(example);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Resource> selectByRowBounds(Resource record, RowBounds rowBounds) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.selectByRowBounds(record, rowBounds);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
     ...
     * @return
     */
    public List<Resource> selectByExampleAndRowBounds(Object example, RowBounds rowBounds) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.selectByExampleAndRowBounds(example, rowBounds);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    /** 其他的tk.mapper通用方法实现 **/
    @Override
    public Resource selectByPrimaryKey(Object key) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.selectByPrimaryKey(key);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    @Override
    public int insertList(List<Resource> recordList) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.insertList(recordList);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    @Override
    public int insertUseGeneratedKeys(Resource record) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.insertUseGeneratedKeys(record);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
    ...
    public int deleteByPrimaryKey(Object key) {
        try {
            ResourceDao resourceDao = getSqlSession().getMapper(ResourceDao.class);
            return resourceDao.deleteByPrimaryKey(key);
        } catch (Exception e) {
            throw new DAOException("查询数据失败", e);
        }
    }
